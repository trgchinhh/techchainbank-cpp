...
#include <chrono>
#include <windows.h>
#include "D:\\picosha2.h"
#include "D:\\json.hpp"
#include "D:\\qrcodegen.hpp"
...
const string file_data = "data.json";
...
bool chuyen_khoan(TaiKhoanDangNhap& taikhoan, string sotaikhoan2, int so_tien_muon_chuyen);
